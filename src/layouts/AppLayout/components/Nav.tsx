  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <ICONS.searchIcon
          className={`absolute right-3 top-1/2 -translate-y-1/2 w-5 text-basicZinc`}
        />
      </div>
      ...
      <div className="flex items-center sm:space-x-6 space-x-2">
        ...
        <div className="relative">
          ...
          <span
            className={`absolute top-0 right-0 block w-2 h-2 bg-basicRed rounded-full ring-2 ring-basicWhite`}
          ></span>
        </div>
      </div>
    </nav>
