...
export const Nav: React.FC = () => {
  ...
  return <nav className={`border-b w-full bg-mistGray flex fixed md:relative items-center md:justify-between justify-around gap-2 sm:px-14 px-8 py-4 z-10`}>
    <div className="relative">
      <input type="text" className={`lg:w-[30rem] md:w-[17rem] sm:w-[22rem] w-[16rem] bg-paleGray outline-none border border-gray-300 py-2 pr-8 pl-3 placeholder:underline rounded-md`} placeholder="Search"
      />
