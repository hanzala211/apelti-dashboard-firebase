...
export const InvoiceLeftPanel: React.FC = () => {
  ...
  return selectedImage === null ?
    <div className="bg-mistGray h-full md:w-full w-0 hidden mt-0.5 md:flex flex-col items-center justify-center">
      ...
      <h1 className="lg:text-[22px] text-[18px] text-center font-semibold">If you have an invoice in the folder, enter it here or</h1>
      <button onClick={handleFile} className="text-darkBlue font-semibold before:w-36 before:-translate-x-1/2 before:left-1/2 before:absolute relative before:h-1 before:bg-darkBlue before:bottom-0">Browse Folders</button>
