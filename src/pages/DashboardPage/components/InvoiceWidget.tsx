...
export const InvoiceWidget: React.FC<{ label: string, amount: number }> = ({ label, amount }) => {
  return <div className={`bg-basicWhite px-4 py-3 flex items-center justify-between rounded-2xl border-[1px]`}>
    <div>
